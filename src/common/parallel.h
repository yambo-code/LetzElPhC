...
{   
    ...
    used in the code*/
    MPI_Comm commW; // always set to MPI_COMM_"W"ORLD (do not free!)
    MPI_Comm commQ; // COMM for "Q"pool
    MPI_Comm commK; // COMM for "K"pool
    MPI_Comm commR; // equal "R"ank cpus from each kpool form commR
