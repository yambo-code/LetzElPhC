                   ...
                   ELPH_cmplx* restrict dvscf_out, MPI_Comm commK)
{
    ...
    */
    ...
    ND_function(matmulX, Nd_cmplxS)('N', 'C', eig, pats, eig_pat, 1.0, 0.0,
                                    nmodes, nmodes, nmodes, nmodes, nmodes,
                                    nmodes);
    ...
    for (ND_int iter = 0; iter < niter; ++iter)
    {
        ...
        ND_function(matmulX, Nd_cmplxS)(
            'N', 'N', eig_pat, dvscf_pat_tmp, dvscf_mode, 1.0, 0.0, nmodes,
            ld_mode, fft_dims[1] * lattice->nfftz_loc, nmodes,
