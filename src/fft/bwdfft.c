            ...
            ELPH_cmplx * wfcG, ELPH_cmplx * wfcr, const bool conjugate)
{
    ...
    */
    ...
    {   
        ...
        for (ND_int ixyz = 0 ; ixyz < fft_buf_size; ++ixyz) plan->fft_data[ixyz] = 0;
        ...
        // d) perform invfft along xy slab
        ND_function(fft_execute_plan, Nd_cmplxS) (plan->bplan_xy);
        
        memcpy(wfcr_tmp,plan->fft_data,sizeof(ELPH_cmplx)*fft_buf_size);
